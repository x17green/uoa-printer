-- Prisma initial migration (initial schema)
-- This SQL is intended to match the current database schema and can be used
-- as the baseline migration for Prisma's migration history.
